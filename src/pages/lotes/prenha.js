...
import DadosPrenha from '../../data/lotes/prenha';
...
export default function prenha({navigation}) {
  return (
    <ScrollView>
      <View style={DefaultStyle.container}>
        <View
          ...
          <View>
            <Text style={LoteStyle.title}>Prenha</Text>
        ...
        <FlatList data={DadosPrenha} renderItem={({item}) => itensflat(item)} />
